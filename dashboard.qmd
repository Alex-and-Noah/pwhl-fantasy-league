...
*: Note that if your play did not play in a game in which their team won, thei will *not* contribute points to your score (this includes dressed goalies that did not get subbed in).
:::
...
if (
  ...
  ) |> merge(data.frame(Team = names(team_colours), Colours = team_colours)
